    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <a href="empresas.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Volver a la empresas</a>
          <div class="page-title">

            <div class="title_left">
              <h3>Usuarios <small>Gestionar todas las sucursales de la Empresa</small></h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-sucursal-crear-modal-lg" id="btn-agregar-usuario">Agregar Sucursal</button>
                    ...
                    <table class="table table-striped jambo_table bulk_action" id="tablaSucursal">
                      <thead>
                        <tr class="headings">
                          ...
                          <th class="column-title">Contacto Nombre </th>
        ...
        <?php include 'modals/sucursales.php'; ?>
      </div>
      <!-- /page content -->
