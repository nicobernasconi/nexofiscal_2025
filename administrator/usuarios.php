    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <a href="sucursales.php?id=<?php echo $_GET['empresa_id'];?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Volver a la usuario</a>
          <div class="page-title">

            <div class="title_left">
              <h3>Usuarios <small>Gestionar todas los usuarios de la usuario</small></h3>
            </div>
          ...
          <div class="row" style="display: block;">
            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
               ...
               <div class="x_content">
                  <input type="hidden" id="sucursal_id" value="<?php echo $_GET['id']; ?>">
                  <input type="hidden" id="empresa_id" value="<?php echo $_GET['empresa_id']; ?>">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-usuario-crear-modal-lg" id="btn-agregar-usuario">Agregar usuario</button>
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action" id="tablaUsuarios">
                      <thead>
                        <tr class="headings">
                          <th>
        ...
        <?php include 'modals/usuarios.php'; ?>
      </div>
      <!-- /page content -->
