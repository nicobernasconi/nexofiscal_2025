...
$lista_precios=$row_usuario['lista_precios']??1;
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            $producto = array(
                ...
                "descripcion_ampliada" => $row['descripcion_ampliada']. " P:" . $lista_precios,
                "stock" => $row['stock'] ?? 0,
                "codigo_barra" => $row['codigo_barra'],
                "articulo_activado" => $row['articulo_activado'],
                "producto_balanza" => $row['producto_balanza'] ?? 0,
                "precio1" => $row['precio'.$lista_precios] ?? 0,
                ...
                "oferta" => $row['oferta'],
                "margen_ganancia" => $row['margen_ganancia']??0,
