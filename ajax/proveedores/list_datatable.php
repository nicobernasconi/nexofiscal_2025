...
try {
    ...
    foreach ($data as $item) {
        $boton_borrar='';
        $boton_modificar='';
        if (in_array('modificar', $permisos_asignados['proveedores'])) {
        $boton_borrar = '<button class="btn-cancelar btn-eliminar-proveedor" data-id="'.$item['id'].'"><i class="fas fa-trash"></i></button>';
        }
         if (in_array('modificar', $permisos_asignados['proveedores'])) {
        $boton_modificar = '<button class="btn-guardar btn-seleccionar-proveedor" data-id="'.$item['id'].'" ><i class="fas fa-pencil"></i></button>';
         }
        $formattedItem = [
            'id' => $item['id'],
