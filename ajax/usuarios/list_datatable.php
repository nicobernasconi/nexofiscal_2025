...
try {
    ...
    foreach ($data as $item) {
        $boton_borrar='';
        $boton_modificar='';
        if (in_array('modificar', $permisos_asignados['usuarios'])) {
        $boton_borrar = '<button class="btn-cancelar btn-eliminar-usuario" data-id="'.$item['id'].'"><i class="fas fa-trash"></i></button>';
        }
         if (in_array('modificar', $permisos_asignados['usuarios'])) {
        $boton_modificar = '<button class="btn-guardar btn-editar-usuario" data-id="'.$item['id'].'" ><i class="fas fa-pencil"></i></button>';
         }
        $formattedItem = [
            'id' => $item['id'],
