...
//crar el parametro fecha_baja con el valor de la fecha de hoy
$post_data['fecha_baja'] = date('Y-m-d H:i:s');
$post_json = json_encode($post_data);


// URL de la API
$url = $ruta.'api/comprobantes/'.$_POST['id'].'/';
...
try {
    ...
    insertUpdateRemoto($con, $post_json,'comprobantes','anular','POST',$id, $url_remoto, $_SESSION['token'], $local);
