...
// URL de la API
$url = $ruta . 'gestor_admin/api/empresas/';
...
try {
    ...
    foreach ($data as $item) {
        $boton_registrar_pago= '<boton class="btn btn-success btn-xs btn-registrar_pago" data-id="'.$item['id'].'"  data-toggle="modal" data-target=".bs-empresa-pago-modal-lg">Registrar Pago</boton>';
