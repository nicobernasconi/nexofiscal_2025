...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    $query_product = "SELECT
                        ...
                        LEFT JOIN gestores_distribuidores ON distribuidores_empresas.distribuidor_id = gestores_distribuidores.distribuidor_id
...
if (isset($_GET['sort_order'])) {
    ...
    if (count($query_param) > 0) {
        $query_product = $query_product . " WHERE   (" . implode(" AND ", $query_param) . ") and gestores_distribuidores.gestor_id = $usuario_id";
    }
