...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        $query_product = "SELECT
                            ...
                            sucursales.telefono, 
                            sucursales.email, 
                            sucursales.contacto_nombre, 
                            sucursales.contacto_telefono, 
                            sucursales.contacto_email, 
                            sucursales.referente_nombre, 
                            sucursales.referente_telefono, 
                            sucursales.referente_email,
                            distribuidores_empresas.distribuidor_id
                          FROM
                            sucursales
                        LEFT JOIN distribuidores_empresas ON sucursales.empresa_id = distribuidores_empresas.empresa_id";
        ...
        $query_total = "SELECT COUNT(*) AS total FROM sucursales LEFT JOIN distribuidores_empresas ON sucursales.empresa_id = distribuidores_empresas.empresa_id WHERE distribuidores_empresas.distribuidor_id = $distribuidor_id ";
        ...
        $query_product = $query_product . " ORDER BY sucursales. " . $order_by . "  " . $sort_order . " LIMIT $limit OFFSET $offset";
