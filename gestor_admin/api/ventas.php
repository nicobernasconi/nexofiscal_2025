...
try {
    ...
    FROM
        ...
        INNER JOIN distribuidores_empresas ON comprobantes.empresa_id = distribuidores_empresas.id
    WHERE
        ...
        $query_total = "SELECT COUNT(*) AS total FROM comprobantes WHERE comprobantes.fecha_baja IS NULL and (" . implode(" and ", $query_param) . ") ";
