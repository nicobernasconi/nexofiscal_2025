    ...
    <table class="bill-container">
        ...
        <tr>
            <td class="border-top padding-t-3 padding-b-3">
                ...
                <p class="text-center text-lg">FACTURA <?php echo ($_POST['tipo_factura'] == 1) ? 'A' : (($_POST['tipo_factura'] == 6) ? 'B' : 'C'); ?></p>
        ...
        <tr class="text-center">
            <td>
                <img style="width: 220px !important;"  id="qrcode" src="<?php echo $_POST['codigo_qr']; ?>" />
