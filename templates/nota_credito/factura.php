...
$template_data = array(
    ...
    'tipo_factura_nombre' => $_POST['tipo_factura'],
    'tipo_factura' => $_POST['tipo_factura'],
    'codigo' => $_POST['tipo_factura'],
    ...
    'total' => $_POST['total'],
    'cae' => $_POST['cae'],
    'vencimiento_cae' => $_POST['vencimiento_cae'],
...
<body>
    <table class="bill-container">
        <tr class="bill-emitter-row">
            <td>
                <div class="bill-type">
                    <?php echo ($template_data['tipo_factura'] == 3) ? 'A' : (($template_data['tipo_factura'] == 8) ? 'B' : 'C'); ?>
                </div>
    ...
    <div class="footer">
        ...
        <div class="qr">
            <div class="col-6">
                <img id="qrcode" src="<?php echo $template_data['codigo_qr']; ?>" />
            </div>
            <div class="col-6 text-right">
                <div class="margin-b-10">
                    <strong>CAE Nº:&nbsp;</strong> <?php echo $template_data['cae']; ?>
                </div>
                <div>
                    <strong>Fecha de Vto. de CAE:&nbsp;</strong> <?php echo date('d-m-Y', strtotime($template_data['vencimiento_cae'])); ?>
                </div>
            </div>
        ...
        <div class="row text-left">
            <p class="col-12 margin-b-0">
                <strong>Firma:</strong> _______________________________________________
            </p>
        </div>
        <div class="row text-left">
            <p class="col-12 margin-b-0">
                <strong>Aclaración:</strong> __________________________________________
            </p>
        </div>
    </div>
</body>
