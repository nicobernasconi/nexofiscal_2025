...
// URL de la API
$url = $ruta . 'distribuidores_admin/api/proveedores/';
...
try {
    ...
    foreach ($data as $item) {
        $boton_borrar = '<button class="btn btn-danger btn-eliminar-proveedor" data-id="' . $item['id'] . '"><i class="fa fa-trash"></i></button>';
        $boton_modificar = '<button class="btn btn-success btn-seleccionar-proveedor" data-id="' . $item['id'] . '" ><i class="fa fa-pencil"></i></button>';
        $formattedItem = [
            'id' => $item['id'],
