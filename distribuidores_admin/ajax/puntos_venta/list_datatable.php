...
// URL de la API
$url = $ruta . 'distribuidores_admin/api/puntos_venta/';
...
try {
    ...
    foreach ($data as $item) {
        ...
        $boton_borrar = '<button class="btn btn-danger btn-eliminar-punto-venta" data-id="'.$item['id'].'"><i class="fa fa-trash"></i></button>';
        $boton_modificar = '<button class="btn btn-primary btn-seleccionar-punto-venta" data-id="'.$item['id'].'"><i class="fa fa-edit"></i></button>';
        $formattedItem = [
            'id' => $item['id'],
