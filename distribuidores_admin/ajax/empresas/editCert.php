...
$post_data['cert']=base64_decode($post_data['cert']);
$post_data['key']=base64_decode($post_data['key']);
// URL de la API
$url = $ruta . 'distribuidores_admin/api/empresas/'.$_POST['empresa_id'].'/';
//eliminar el id del arreglo
unset($post_data['empresa_id']);
