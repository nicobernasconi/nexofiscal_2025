...
// URL de la API
$url = $ruta.'distribuidores_admin/api/sessions/';
...
try {
    ...
    foreach ($data as $item) {
        ...
        $boton_borrar = '<button class="btn btn-danger btn-seleccionar-sesion" data-toggle="modal" data-target=".bs-session-eliminar-modal-lg" data-id="' . $item['id'] . '" data-toggle="tooltip" data-placement="top" title="Cerrar sesion"><i class="fa fa-close"></i></button>';
