...
if (isset($_GET['sort_order'])) {
    ...
    $_GET = array_filter($_GET);
        ...
        if (isset($_GET['nro_cliente'])) {
            ...
            array_push($query_param, "clientes.nro_cliente like '%$nro_cliente%'");
        }
        ...
        if (isset($_GET['cuit'])) {
            ...
            array_push($query_param, "cuit like '%$cuit%'");
        }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query_check_duplicate = "SELECT COUNT(*) AS count FROM clientes WHERE cuit = :cuit  and empresa_id = $empresa_id";
