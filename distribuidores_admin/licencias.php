  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12  ">
              <div class="x_panel">
               ...
               <div class="x_content">
                  ...
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-licencia-crear-modal-lg" id="btn-agregar-licencia">Agregar licencia</button>
                  <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bs-sesiones-activas-modal-lg" id="btn-sesiones-activas">Sesiones activas</button>
                  
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action" id="tablaLicencia">
                      <thead>
                        <tr class="headings">
        ...
        <?php include 'modals/licencias.php'; ?>
      </div>
      <!-- /page content -->
