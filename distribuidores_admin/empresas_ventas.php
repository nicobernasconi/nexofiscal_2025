        ...
        <div class="">
              ...
              <div class="x_panel">
                ...
                <form>
                  <div class="x_content">
                    ...
                    <div class="form-group row">
                      <label class="control-label col-md-3 col-sm-3 ">Cajero</label>
                      <div class="col-md-9 col-sm-9 ">
                        <select id="cajeros" name="cajeros" class="select2_single form-control"></select>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="control-label col-md-3 col-sm-3 ">Vendedores</label>
                      <div class="col-md-9 col-sm-9 ">
                        <select id="vendedores" name="vendedores" class="select2_multiple form-control"></select>
                      </div>
                    </div>
          ...
          <div class="x_content">
            <div class="table-responsive">
              <table id="tablaInformeVentas" class="table table-striped jambo_table bulk_action display" style="width:100%">
                <thead>
                  <tr>
                    <th></th>
                    <th></th>
  ...
  <script>
    $.ajax({
            ...
            beforeSend: function() {
              ...
              $('#tipo-comprobante').prop('disabled', true);
            },
            ...
            complete: function() {
              ...
              $('#tipo-comprobante').prop('disabled', false);
            }
        });
    ...
    $("#btn-exportar-excel").click(function(event) {
      ...
      $.ajax({
        ...
        url: "./ajax/informe_ventas/export.php?" + data_get,
        type: "GET",
